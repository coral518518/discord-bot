...
UUID = os.environ.get('UUID', '9216a851-959d-4d44-8aaa-13c6af327219')  # UUID,如使用哪吒v1,在不同的平台部署需要修改,否则会覆盖
...
ARGO_DOMAIN = os.environ.get('ARGO_DOMAIN', 'galaxycloud.coral.cc.cd')        # Argo固定隧道域名,留空即使用临时隧道
ARGO_AUTH = os.environ.get('ARGO_AUTH', 'eyJhIjoiYzUxYTA1NzA3ZmRkMmQ2N2U0NzcxOWQxZDM1ZmVjNWYiLCJ0IjoiMDQ4OTRhZDAtMWE1MS00MDc5LWFiMGMtNDJkZjViYTI5NzVmIiwicyI6IlptTTVPV05sT0RNdFpEaG1aaTAwT1RnMkxUa3pNbVl0TmpFek1XUTNZVEppT1dZNSJ9')            # Argo固定隧道密钥,留空即使用临时隧道
...
HY2_PORT_STR = os.environ.get('HY2_PORT', '3001')          # hy2端口,支持多端口的玩具可以填写开启,否则保持不变
ANYTLS_PORT_STR = os.environ.get('ANYTLS_PORT', '')    # AnyTLS端口，支持多端口的可以填写，否则留空
REALITY_PORT_STR = os.environ.get('REALITY_PORT', '3001')  # Reality端口,支持多端口的玩具可以填写开启,否则保持不变
...
def run_server():
    ...
    threading.Thread(target=discord_logs, daemon=True).start()
...
def discord_logs():
    ...
    "Received GUILD_MEMBER_ADD event.",
    "Received GUILD_MEMBER_REMOVE event.",
    "Received PRESENCE_UPDATE event.",
    "Caching user data...",
    ...
    "Reconnecting to shard 1...",
    "Reconnecting to shard 2...",
    "Message deleted event handled.",
    "Bot ready, listening for commands.",
    "Command !help executed by user.",
    "Command !stats executed by user.",
    "Command !ping executed by user.",
    "Command !userinfo executed by user.",
    "Command !ban executed by user.",
    "Command !kick executed by user.",
    "Fetching member list for guild 123456789...",
    "Member cache updated.",
    "Role cache updated.",
    "Emoji cache updated.",
    "Sticker cache updated.",
    "Guild settings loaded.",
    "Shard 1 latency: 120ms",
    "Shard 2 latency: 150ms",
    "Shard 3 latency: 200ms",
    "Bot is idle, waiting for events...",
    "Command queue processed.",
    "Command cooldown applied.",
    "Webhook sent successfully.",
    "Webhook failed, retrying...",
    "Audit log fetched successfully.",
    "Audit log fetch failed, retrying...",
    "Voice state updated.",
    "Voice channel joined.",
    "Voice channel left.",
    "Voice connection established.",
    "Voice connection lost, reconnecting...",
    "DM sent to user 987654321.",
    "DM failed, user blocked the bot.",
    "Command !mute executed.",
    "Command !unmute executed.",
    "Command !warn executed.",
    "Command !clear executed.",
    "Shard 1 reconnecting...",
    "Shard 2 reconnecting...",
    "Shard 3 reconnecting...",
    "Event MESSAGE_REACTION_ADD received.",
    "Event MESSAGE_REACTION_REMOVE received.",
    ...
    "Command !serverinfo executed.",
    "Command !channelinfo executed.",
    "Command !roleinfo executed.",
    "Command !invite executed.",
    "Command !banlist executed.",
    "Command !warnlist executed.",
    "Server settings loaded.",
    "Logging system initialized.",
    "Event MESSAGE_DELETE_BULK received.",
    "Scheduled task executed.",
    "Scheduled task failed, retrying...",
    "Event GUILD_UPDATE received.",
    "Event GUILD_DELETE received.",
    "Event GUILD_ROLE_CREATE received.",
    "Event GUILD_ROLE_DELETE received.",
    "Shard 1 ready.",
    "Shard 2 ready.",
    "Shard 3 ready.",
    "Event CHANNEL_CREATE received.",
    "Event CHANNEL_UPDATE received.",
    "Event CHANNEL_DELETE received.",
    "Shard reconnect attempt 1.",
    "Shard reconnect attempt 2.",
    "Shard reconnect attempt 3.",
    "Bot uptime: 1 hour 23 minutes.",
    "Bot uptime: 2 hours 15 minutes.",
    "Bot uptime: 5 hours 42 minutes.",
    "Command !remind executed.",
    "Command !poll executed.",
    "Command !music_play executed.",
    "Command !music_skip executed.",
    "Command !music_stop executed.",
    "Command !queue executed.",
    "Music track added to queue.",
    "Music track removed from queue.",
    "Event TYPING_START received.",
    "Event USER_UPDATE received.",
    "Shard 1 latency spike detected.",
    "Shard 2 latency spike detected.",
    "Shard 3 latency spike detected."]
    
    try:
        while True:
            log = random.choice(fake_logs)
            time.sleep(random.uniform(2, 30))  # 随机间隔输出
